-- SK Trade International — database schema (SQLite)
--
-- This runs on Node's built-in node:sqlite module so the project has zero
-- external dependencies and zero network calls at setup time. For production,
