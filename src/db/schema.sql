...
--
-- REFERENCE COPY. The actual runtime schema lives in schema.ts as an exported
-- string constant, not as a file read at request time — see the comment at
-- the top of index.ts for why. Keep this file and schema.ts in sync if you
-- change the schema; this copy exists because a .sql file is a much more
-- readable diff/reference than the same content wrapped in a template literal.
--
